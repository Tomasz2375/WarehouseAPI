        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdmissionDate = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: false),
                    PreparationDate = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: false),
                    PostDate = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: false),
                    RequireDate = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: false),
